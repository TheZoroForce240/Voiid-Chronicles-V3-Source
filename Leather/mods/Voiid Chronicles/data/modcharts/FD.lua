...
function createPost()
    ...
    setShaderProperty('bv', 'effect', 0.0)
    setShaderProperty('bv', 'strength', 0.0)
...
function stepHit()
	...
	if secStep == 0 then 
		...
		elseif section == 72 or section == 164 then 
            ...
            tweenShaderProperty('bv', 'effect', 15, crochet*0.001*8, 'cubeOut')
            tweenShaderProperty('bv', 'strength', 0.25, crochet*0.001*8, 'cubeOut')
            doShake(2, 0.01)
		...
		elseif section == 88 then 
            ...
            perlinSpeed = 0.0
            tweenShaderProperty('bv', 'effect', 0, crochet*0.001*8, 'cubeOut')
            tweenShaderProperty('bv', 'strength', 0.0, crochet*0.001*8, 'cubeOut')
            tweenShaderProperty('sparks', 'scale', 0.0, crochet*0.001*8, 'cubeOut')
		elseif section == 96 then 
			perlinCamRange = {0.05,0.05,8,0}
			perlinSpeed = 2
		elseif section == 180 then 
            ...
            tweenShaderProperty('bv', 'strength', 0.0, crochet*0.001*8, 'cubeOut')
            tweenShaderProperty('sparks', 'scale', 0.0, crochet*0.001*8, 'cubeOut')
        elseif section == 196 then 
            bloomBurst(2, 2, 16, 'cubeOut')
			perlinCamRange = {0.0,0.0,0,0}
			perlinSpeed = 0

        elseif section == 55 or section == 147 then 
	...
	if (section >= 0 and section < 8) or (section >= 92 and section < 96) or (section >= 188 and section < 196) then --slow bump
        if secStep == 0 then 
    ...
    if (section >= 8 and section < 88) or (section >= 96 and section < 188) then --bump
        if secStep8 == 0 then
            tweenShaderProperty('mirror', 'zoom', 1.0, crochet*0.001*4, 'cubeOut')
    ...
    if section == 88 then 
        if secStep == 0 then 
            tweenShaderProperty('mirror', 'zoom', 2, crochet*0.001*8, 'elasticOut')
        elseif secStep == 8 then 
            tweenShaderProperty('mirror', 'zoom', 3, crochet*0.001*8, 'elasticOut')
        end
    elseif section == 89 then 
        if secStep == 0 then 
            tweenShaderProperty('mirror', 'zoom', 4, crochet*0.001*8, 'elasticOut')
        elseif secStep == 8 then 
            tweenShaderProperty('mirror', 'zoom', 5, crochet*0.001*8, 'elasticOut')
        end
    elseif section == 90 then 
        if secStep == 8 then 
            tweenShaderProperty('mirror', 'zoom', 4, crochet*0.001, 'cubeOut')
        elseif secStep == 9 then 
            tweenShaderProperty('mirror', 'zoom', 3, crochet*0.001, 'cubeOut')
        elseif secStep == 10 then 
            tweenShaderProperty('mirror', 'zoom', 2, crochet*0.001, 'cubeOut')
        elseif secStep == 11 then 
            tweenShaderProperty('mirror', 'zoom', 1.5, crochet*0.001, 'cubeOut')
        end
