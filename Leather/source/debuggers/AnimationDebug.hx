...
class AnimationDebug extends MusicBeatState
{
	...
	override function create()
	{
		...
		//test.frames = FlxAnimateFrames.fromTextureAtlas()

		//var test = new FlxAnimate(0, 0, Paths.file("images/characters/WIIK3TARO"));
		///test.anim.addBySymbol("idle", "Idle", 24, true);
		//test.anim.play("idle");
